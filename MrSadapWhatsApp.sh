...
echo  $blue "<|                                      |>"
echo  $blue "<| Name: MR.CR4CK3D    ||    MR.CR4CK3D   |>"
echo  $blue "<| MyTeam: MR.CR4CK3D D4RKCYB3RT34M         |>"
echo  $blue "<| Contact: -             |>"
echo  $blue "<| Thanks To: MR.CR4CK3D D4RKCYB3RT34M      |>"
echo  $blue "<|======================================|>"
sleep 1
...
read -p"╰───────root@MR.CR4CK3D=•>" MR.CR4CK3D;
if [ $MR.CR4CK3D = 1 ] || [ $MR.CR4CK3D = 01 ]
then
